...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.original_author'
        db.add_column(u'articles_article', 'original_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_articles', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.original_author'
        db.delete_column(u'articles_article', 'original_author_id')
