...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.links_count'
        db.add_column(u'articles_article', 'links_count',
    ...
    def backwards(self, orm):
        # Deleting field 'Article.links_count'
        db.delete_column(u'articles_article', 'links_count')
    ...
    models = {
        u'articles.article': {
            ...
            'links_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
