...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScoreTransaction'
        db.create_table(u'scoring_scoretransaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Author'])),
        ...
        db.send_create_signal('scoring', ['ScoreTransaction'])


    def backwards(self, orm):
        # Deleting model 'ScoreTransaction'
        db.delete_table(u'scoring_scoretransaction')
    ...
    models = {
        ...
        'scoring.scoretransaction': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.Author']"}),
